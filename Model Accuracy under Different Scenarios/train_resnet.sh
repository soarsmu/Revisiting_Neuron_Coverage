...
python train_resnet.py --model_name resnet32 --dataset eurosat --num_classes 10

## train resnet20 on eurosat
python train_resnet.py --model_name resnet20 --dataset eurosat --num_classes 10
